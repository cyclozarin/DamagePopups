...
namespace DamagePopups.Behaviours
{
    ...
    {
        private Vector3 _desiredFadeOutPosition;
        ...
        private void Start()
        {
            ...
            _desiredFadeOutPosition = gameObject.transform.position + Random.insideUnitSphere;
        ...
        private IEnumerator MoveAndFadeOut()
        {
            ...
            while (_counter < _fadeOutTime)
            {
                ...
                gameObject.transform.LookAt(MainCamera.instance.transform);
                gameObject.transform.Rotate(new(0, 180, 0));
                gameObject.transform.position = Vector3.Lerp(gameObject.transform.position, _desiredFadeOutPosition, _fadeOutTime);
